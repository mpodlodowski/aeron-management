...
public class AgentConfig {
    ...
    public AgentConfig() {
        ...
        this.managementServerPort = Integer.parseInt(env("AERON_MANAGEMENT_SERVER_PORT", "8081"));
        ...
        this.stateBufferSize = Integer.parseInt(env("AERON_MANAGEMENT_AGENT_STATE_BUFFER_SIZE", "500"));
    }
